...
<div id="top">
    <h2 style="align-content: center;">Surveys Hosted By You</h2>
</div>
<div id="btn">
    <button id="createSurvey" style="background-color: #184770; border-color:wheat; color: white; width: 150px; height: 50px;" type="button">Create Survey</button>
</div>
<div  style="margin-top: 200px " id="allSurveys">

</div>
</body>
<script src="https://code.jquery.com/jquery-3.5.1.js" integrity="sha256-QWo7LDvxbWT2tbbQ97B53yJnYU3WhH/C8ycbRAkjPDc=" crossorigin="anonymous"></script>
<script src="static/js/institutionSurvey.js"></script>
</html>
